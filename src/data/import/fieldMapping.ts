...
const fieldAliases: Partial<Record<ImportField, string[]>> = {
  ...
  impressions: ["impressions", "impr", "展示", "展示量", "曝光", "曝光量"],
  clicks: ["clicks", "click", "点击", "点击量"],
  installs: ["installs", "install", "首次安装", "安装", "安装量"],
  activations: ["activations", "activation", "激活", "激活数", "激活量"],
