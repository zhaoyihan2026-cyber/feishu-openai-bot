...
const fieldAliases: Partial<Record<ImportField, string[]>> = {
  ...
  d0Roas: ["d0roas", "d0回收", "d0广告回收"],
  arppu: ["arppu"],
  paymentRate: ["paymentrate", "payrate", "付费率"],
  installRate: ["ir", "installrate", "安装率"],
  ctr: ["ctr"],
  cvr: ["cvr"],
  installRegistrationRate: [
    "installregistrationrate",
    "installtorigistrationrate",
    "安装注册率",
  ],
  cpm: ["cpm"],
  cpc: ["cpc"],
  ...
  cpr: ["cpr"],
  cpp: ["cpp"],
  d1RetentionRate: ["d1retention", "d1retentionrate", "d1留存", "d1留存率"],
  d7RetentionRate: ["d7retention", "d7retentionrate", "d7留存", "d7留存率"],
  selected: ["selected", "selection", "单选"],
  revenueD7Usd: [
    "revenued7",
    "d7revenue",
    "d7revenueusd",
